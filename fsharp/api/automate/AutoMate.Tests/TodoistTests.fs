...
let todoistTests =
  ...
  "snake_case": "foo bar"
    ...
    testCase "deserializeValidator<ItemDto>" (fun _ ->
      let input =
        """
          {
            "id": "8283578355",
      ...
      let output =
        AutoMate.Integrations.Todoist.deserializeValidator<
          AutoMate.Integrations.Todoist.SyncApi.V9.ItemDto
         >
          "test"
          input
    ...
    testCase "deserializeValidator<NoteDto>" (fun _ ->
      let input =
        """
          {
            "id": "3651431408",
      ...
      let output =
        AutoMate.Integrations.Todoist.deserializeValidator<
          AutoMate.Integrations.Todoist.SyncApi.V9.NoteDto
         >
          "test"
          input
